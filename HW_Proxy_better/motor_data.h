...
union motor_data_t {
    struct {
        ...
        unsigned short int direction : 2;
        unsigned short int speed : 5;
        unsigned short int error_status : 1;
        unsigned short int error_no_power : 1;
        unsigned short int error_no_torque : 1;
        unsigned short int error_bit_false :1;
        unsigned short int error_over_temperature : 1;
        unsigned short int error_reverse_1 : 1;
        unsigned short int error_reverse_2 : 1;
        unsigned short int error_unknown : 1;
    } bit;
...
union motor_data_t {
    struct {
        ...
        unsigned char error_over_temperature : 1;
